...
<body>
    ...
    <?php $pageRoute = 'user/movies'; ?>

    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
        <h1 class="display-4">Favorite Movies</h1>
    </div>

    <div class="container">
        <div class="row">
            <?php $v22954860991iterated = false; ?><?php foreach ($page->items as $movie) { ?><?php $v22954860991iterated = true; ?>
                <div class="col-md-4">
            ...
            <?php } if (!$v22954860991iterated) { ?>
                <p>No movies have been added to favorites yet.</p>
                <div class="d-flex justify-content-between align-items-center">
                    <a href="<?= $this->url->get('movies') ?>" class="btn btn-sm btn-primary">Go to movie collection</a>
                </div>
            <?php } ?>
